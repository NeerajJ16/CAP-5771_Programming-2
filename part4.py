...
def compute():
    ...
    for dataset_name in answers["4A: datasets"].keys():
        ...
        for cluster_type in ['single','complete','ward','average']:
            preds=fit_hierarchical_cluster_B(answers["4A: datasets"][dataset_name][0],answers["4A: datasets"][dataset_name][1],cluster_type,2)
    ...
    myplt.plot_part1C(ac_value,'Part4Question2.jpg')
    ...
    for dataset_name in answers["4A: datasets"].keys():
        ...
        lst =[]
        for cluster_type in ['single','complete','ward','average']:
            preds=fit_modified(answers["4A: datasets"][dataset_name][0],answers["4A: datasets"][dataset_name][1],cluster_type)
            dataset_cluster[cluster_type]=preds
        lst.append((answers["4A: datasets"][dataset_name][0],answers["4A: datasets"][dataset_name][1]))
        lst.append(dataset_cluster)
        ac_value[dataset_name]=lst
    myplt.plot_part1C(ac_value,'Part4Question3.jpg')
